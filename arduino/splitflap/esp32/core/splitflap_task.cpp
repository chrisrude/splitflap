...
SplitflapTask::SplitflapTask(const uint8_t task_core, const LedMode led_mode) : Task("Splitflap", 16384, 1, task_core), led_mode_(led_mode), state_semaphore_(xSemaphoreCreateMutex()) {
